/**
 * 二测试题,上下布局
 * Created by gaoju on 2018/12/18
 */
...
class Question extends Component{
    ...
    render(){
        ...
        //获取各部分的高度
        let hh = ($(window).height()-$('.Question_content').height()-$('header').height() -100)+'px';
        let minh = (780-$('.Question_content').height()-$('header').height() -100)+'px';
