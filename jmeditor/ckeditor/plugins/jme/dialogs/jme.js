                ...
                elements: [
                    {
                        ...
                        html: '<div style="width:350px;height:300px;"><iframe id="' + jme_fid + '" style="width:350px;height:300px;" frameborder="no" src="' + CKEDITOR.basePath + 'plugins/jme/dialogs/mathdialog.html"></iframe></div>'
                    }   
                ]
            }
        ],
